...
public class NotaTest {
    ...
    public void verifySuma(int notaN, String expectedResult){
        String actualResult = nota.getMessage(notaN);
        Assertions.assertEquals(expectedResult,actualResult,"ERROR! el mensaje retornado es incorrecto verifique con la nota: "+notaN);
    }
}
